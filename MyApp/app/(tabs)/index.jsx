    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
            ...
            <Pressable 
              ...
              <View style={styles.modalHead}>
                <Pressable
                  ...
                  <SymbolView name="xmark" style={styles.modalIcon} tintColor='black'/>
                </Pressable>
              </View>
        ...
        <View style={styles.calendarHeader}>
          ...
          <Pressable style={styles.arrowIcon} onPress={() => setModalVisible(true)}>
            <SymbolView name="chevron.down" style={styles.modalIcon} tintColor='black'/>
          </Pressable>
        </View>
